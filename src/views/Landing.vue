            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">We provide cost-effective services
                                    <span></span>
                                </h1>
                                <p class="lead  text-white">We will listen to what the system development is for, the budget and scale, and make a proposal that is highly cost-effective for the customer.</p>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Design production</h6>
                                    <p class="description mt-3">We can design and produce logos, business cards, flyers, etc.</p>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Website Design</h6>
                                    <p class="description mt-3">We will listen to your needs and propose the most cost-effective way to open a new store, such as creating a website to attract customers, or updating the design of the website you created in the past to make it compatible with smartphones.</p>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">System development</h6>
                                    <p class="description mt-3">If you would like to start a new service, please feel free to contact us for a free consultation. We also accept work on contract projects and quasi-delegation contracts. We specialize in system development using PHP, and frameworks such as Laravel, CakePHP, FuelPHP, and CodeIgniter can be accommodated according to customer requirements, and we also accept development with a company's own CMS.</p>
                                </card>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            ...
                            <blockquote class="card-blockquote">
                                ...
                                <h4 class="display-3 font-weight-bold text-white">Winroader</h4>
                                <p class="lead text-italic text-white">We support my client to build eco-system</p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="col-md-6">
